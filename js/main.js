...
/***/ function(module, exports, __webpack_require__) {
	...
	var me = new models_1.User('Juliet', '');
	var ladycap = new models_1.User('Lady Capulet', '');
	var echo = new models_1.User('Echo Bot', '');
	var rev = new models_1.User('Reverse Bot', '');
	var wait = new models_1.User('Waiting Bot', '');
